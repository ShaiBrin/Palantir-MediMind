...
export interface DisplayMetadataLimitsError_actionTypeParameterDisplayNameError {
    ...
    actionTypeParameterDisplayNameError: ActionTypeParameterDisplayNameTooLongError;
}
export interface DisplayMetadataLimitsError_actionTypeParameterDescriptionError {
    type: "actionTypeParameterDescriptionError";
    actionTypeParameterDescriptionError: ActionTypeParameterDescriptionTooLongError;
}
...
export type DisplayMetadataLimitsError = DisplayMetadataLimitsError_objectTypeDisplayNameError | DisplayMetadataLimitsError_objectTypeDescriptionError | DisplayMetadataLimitsError_propertyTypeDisplayNameError | DisplayMetadataLimitsError_propertyTypeDescriptionError | DisplayMetadataLimitsError_linkTypeDisplayNameError | DisplayMetadataLimitsError_actionTypeDisplayNameError | DisplayMetadataLimitsError_actionTypeDescriptionError | DisplayMetadataLimitsError_actionTypeSectionDisplayNameError | DisplayMetadataLimitsError_actionTypeSectionDescriptionError | DisplayMetadataLimitsError_actionTypeParameterDisplayNameError | DisplayMetadataLimitsError_actionTypeParameterDescriptionError | DisplayMetadataLimitsError_sharedPropertyTypeDisplayNameError | DisplayMetadataLimitsError_sharedPropertyTypeDescriptionError | DisplayMetadataLimitsError_interfaceTypeDisplayNameError | DisplayMetadataLimitsError_interfaceTypeDescriptionError | DisplayMetadataLimitsError_interfaceLinkTypeDisplayNameError | DisplayMetadataLimitsError_interfaceLinkTypeDescriptionError | DisplayMetadataLimitsError_ruleSetNameError | DisplayMetadataLimitsError_ruleSetDescriptionError | DisplayMetadataLimitsError_ruleSetNamedTypeNameError | DisplayMetadataLimitsError_workflowDisplayNameError | DisplayMetadataLimitsError_workflowDescriptionError | DisplayMetadataLimitsError_workflowArchetypeIdError | DisplayMetadataLimitsError_workflowArchetypeVersionError | DisplayMetadataLimitsError_typeGroupDisplayNameError | DisplayMetadataLimitsError_typeGroupDescriptionError;
//# sourceMappingURL=DisplayMetadataLimitsError.d.ts.map